let tareas = [
    { id: 1, tarea: "Estudiar JavaScript", estado: false },
    { id: 2, tarea: "Hacer el desafío", estado: false },
    { id: 3, tarea: "Subir por Git", estado: false }
];
...
function renderizarTareas() {
    ...
    for (let tarea of tareas) {
        ...
        itemTarea.innerHTML = `
            <span class="${tarea.estado ? 'completed' : ''}">${tarea.id}. ${tarea.tarea}</span>
            <input type="checkbox" class="statusCheckbox" ${tarea.estado ? 'checked' : ''} data-id="${tarea.id}">
